...
class MusicsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create music" do
    assert_difference('Music.count') do
      post musics_url, params: { music: { name: @music.name, price: @music.price, release_year: @music.release_year, singers: @music.singers } }
    end
  ...
  test "should update music" do
    patch music_url(@music), params: { music: { name: @music.name, price: @music.price, release_year: @music.release_year, singers: @music.singers } }
